            ...
            <div class="container">
                <div class="site-footer-inner">
                    <div class="brand footer-brand">
						<!-- <img src="https://www.nu-deals.co.il/assets/images/logo1.jpg">
						<div class="footer-copyright">&copy; 2021 נו דילס בע"מ</div> -->
                    </div>
                    ...
                    <ul class="footer-social-links list-reset">
                        <!-- <li>
                            <a href="https://www.facebook.com/Nudeals18">
                        ...
                        <li>
                            <a href="https://twitter.com/Nudeals1">
                        ...
                        <li>
                            <a href="https://www.instagram.com/nu_deals/">
